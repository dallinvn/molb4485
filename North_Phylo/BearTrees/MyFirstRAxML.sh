...
raxmlHPC-PTHREADS-AVX -T 8  -f a -m GTRGAMMA -p 618 -N 50  -x 309 -s KnownBears.aln -n KnownBearTree -w /project/inbre-train/inbre018/molb4485/North_Phylo/BearTrees -o GiantPanda
